...
import vahy.original.solutionExamples.Benchmark21Solution;
...
public class Benchmark20SolutionAdv extends DefaultLocalBenchmarkAdv {
    private int iterationCount;

    public Benchmark20SolutionAdv(int iterationCount) {
    ...
    public static void main(String[] args) {
        ...
        benchmark.runBenchmark();
        benchmark = new Benchmark20SolutionAdv(30);
        benchmark.runBenchmark();
        benchmark = new Benchmark20SolutionAdv(40);
        benchmark.runBenchmark();
        benchmark = new Benchmark20SolutionAdv(50);
        benchmark.runBenchmark();
        benchmark = new Benchmark20SolutionAdv(60);
        benchmark.runBenchmark();
    }
