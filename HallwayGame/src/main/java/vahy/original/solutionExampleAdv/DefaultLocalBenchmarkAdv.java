...
import vahy.original.game.HallwayGameInitialInstanceSupplierAdv;
...
public class DefaultLocalBenchmarkAdv {

    public static final Logger logger = LoggerFactory.getLogger(DefaultLocalBenchmarkAdv.class.getName());
    ...
    public void runBenchmark() {
        ...
        PaperExperimentEntryPoint.createExperimentAndRun(
                HallwayAction.class,
                HallwayGameInitialInstanceSupplierAdv::new,
