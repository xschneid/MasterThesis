...
public class Benchmark01SolutionAdv extends DefaultLocalBenchmarkAdv {

    private static Logger logger = LoggerFactory.getLogger(vahy.original.solutionExamples.Benchmark01Solution.class.getName());

    public static void main(String[] args) {
        var benchmark = new Benchmark01SolutionAdv();
